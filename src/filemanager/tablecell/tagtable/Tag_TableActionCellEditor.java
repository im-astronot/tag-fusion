 ...
 * @author Kanak RT
 */
public class Tag_TableActionCellEditor extends DefaultCellEditor{

    private Tag_TableActionEvent event;
    public Tag_TableActionCellEditor(Tag_TableActionEvent event) {
        super(new JCheckBox());
        this.event = event;
    }
